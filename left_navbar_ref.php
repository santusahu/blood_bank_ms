...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index.php" class="brand-link">
    <img src="Images/logo/logo1.jpeg" alt="Blood Bank" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="index.php" class="nav-link <?php if($pagename == 'index.php' ){echo 'active';}?>">
            <i class="nav-icon fas fa-home"></i><p>Dashboard</p>
          </a>
        </li>

        <!-- 2 lavel drop down -->
        <li class="nav-item <?php if($pagename == 'head_quarter_master.php' || $pagename == 'area_master.php'  || $pagename == 'medicine_master.php' || $pagename == 'doctor_master.php' ){echo 'menu-open';}?>">
          <a href="#" class="nav-link <?php if($pagename == 'head_quarter_master.php' || $pagename == 'area_master.php' || $pagename == 'medicine_master.php' || $pagename == 'doctor_master.php'  ){echo 'active';}?>">
          ...
          <ul class="nav nav-treeview">
            <!-- head_quarter_master -->
            <li class="nav-item">
              <a href="head_quarter_master.php" class="nav-link <?php if($pagename == 'head_quarter_master.php' ){echo 'active';}?>">
            ...
            <!-- area_master -->
            <li class="nav-item">
              <a href="area_master.php" class="nav-link <?php if($pagename == 'area_master.php' ){echo 'active';}?>">
            ...
            <!-- medicine_master -->
            <li class="nav-item">
              <a href="medicine_master.php" class="nav-link <?php if($pagename == 'medicine_master.php' ){echo 'active';}?>">
            ...
            <!-- medicine_master -->
            <li class="nav-item">
              <a href="doctor_master.php" class="nav-link <?php if($pagename == 'doctor_master.php' ){echo 'active';}?>">
        ...
        <!-- Sales -->
        <li class="nav-item  <?php if($page_module == 'transection'){echo 'menu-open';}?>">
          <a href="#" class="nav-link <?php if($page_module == 'transection'){echo 'active';}?>">
            <i class="nav-icon fas fa-tree"></i>
            <p><i class="fas fa-angle-left right"></i>Sales</p>
          </a>
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?php echo $product_sales_enter;?>" class="nav-link <?php if($pagename == 'dr_pro_sales_entery.php' ){echo 'active';}?>">
            ...
            <li class="nav-item">
              <a href="<?php echo $product_sales_enter;?>?list=1" class="nav-link <?php if($pagename == 'dr_pro_sales_entery.php?list=1' ){echo 'active';}?>">
                <i class="far fa-circle nav-icon"></i>
                <p>Sales Entery List</p>
              </a>
            </li>
            <li class="nav-item">
